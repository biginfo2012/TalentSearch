...
!function (e) {
    ...
    e.infinitescroll = function (i, t, o) {
        ...
        _binding: function (e) {
            ...
            return o.v = "2.0b2.120520", o.behavior && this["_binding_" + o.behavior] !== i ? void this["_binding_" + o.behavior].call(this) : "bind" !== e && "unbind" !== e ? (this._debug("Binding value  " + e + " not valid"), !1) : ("unbind" === e ? this.options.binder.unbind("smartscroll.infscr." + t.options.infid) : this.options.binder[e]("smartscroll.infscr." + t.options.infid, function () {
                t.scroll()
            ...
            return n.loading.start = n.loading.start || function () {
                e(n.navSelector).hide(), n.loading.msg.appendTo(n.loading.selector).fadeIn(n.loading.speed, e.proxy(function () {
                    this.beginAjax(n)
                }, r))
            ...
            function i() {
                return e(t.options.contentSelector).height() <= o.height()
            }

            var t = this, o = e(window);
            this._prefill = function () {
                i() && t.scroll(), o.bind("resize.infinite-scroll", function () {
                    i() && (o.unbind("resize.infinite-scroll"), t.scroll())
                })
            }, this._prefill()
        }, _debug: function () {
            ...
            var t = this.options;
            if (t.behavior && this["_error_" + t.behavior] !== i) return void this["_error_" + t.behavior].call(this, e);
            ...
            var a, s = this.options, r = this.options.callback,
                l = s.state.isDone ? "done" : s.appendCallback ? "append" : "no-append";
            if (s.behavior && this["_loadcallback_" + s.behavior] !== i) return void this["_loadcallback_" + s.behavior].call(this, t, o, n);
            switch (l) {
                case"done":
                    return this._showdonemsg(), !1;
                case"no-append":
                    if ("html" === s.dataType && (o = "<div>" + o + "</div>", o = e(o).find(s.itemSelector)), 0 === o.length) return this._error("end");
                    break;
                case"append":
                    var c = t.children();
            ...
            var t = this.options, o = 0 + e(document).height() - t.binder.scrollTop() - e(window).height();
            ...
            var t = this.options;
            if (t.behavior && this["_pausing_" + t.behavior] !== i) return void this["_pausing_" + t.behavior].call(this, e);
            ...
            var e = this.options;
            return e.behavior && this["_setup_" + e.behavior] !== i ? void this["_setup_" + e.behavior].call(this) : (this._binding("bind"), !1)
        }, _showdonemsg: function () {
            var t = this.options;
            if (t.behavior && this["_showdonemsg_" + t.behavior] !== i) return void this["_showdonemsg_" + t.behavior].call(this);
            ...
            for (var t in i) if (t.indexOf && t.indexOf("Selector") > -1 && 0 === e(i[t]).length) return this._debug("Your " + t + " found no elements."), !1;
            return !0
        }, bind: function () {
            this._binding("bind")
        }, destroy: function () {
            ...
            var o, n, a, s, r = this, l = t.path;
            if (t.state.currPage++, t.maxPage !== i && t.state.currPage > t.maxPage) return t.state.isBeyondMaxPage = !0, void this.destroy();
            switch (o = e(e(t.contentSelector).is("table, tbody") ? "<tbody/>" : "<div/>"), n = "function" == typeof l ? l(t.state.currPage) : l.join(t.state.currPage), r._debug("heading into ajax", n), a = "html" === t.dataType || "json" === t.dataType ? t.dataType : "html+callback", t.appendCallback && "html" === t.dataType && (a += "+callback"), a) {
                case"html+callback":
                ...
                case"json":
                    r._debug("Using " + a.toUpperCase() + " via $.ajax() method"), e.ajax({
                        ...
                        success: function (e, a, l) {
                            if (s = "undefined" != typeof l.isResolved ? l.isResolved() : "success" === a || "notmodified" === a, t.appendCallback) if (t.template !== i) {
                                var c = t.template(e);
                                o.append(c), s ? r._loadcallback(o, c) : r._error("end")
                            } else r._debug("template must be defined."), r._error("end"); else s ? r._loadcallback(o, e, n) : r._error("end")
                        },
                        error: function () {
            ...
            return n.behavior && this["retrieve_" + n.behavior] !== i ? void this["retrieve_" + n.behavior].call(this, t) : n.state.isDestroyed ? (this._debug("Instance is destroyed"), !1) : (n.state.isDuringAjax = !0, void n.loading.start.call(e(n.contentSelector)[0], n))
        }, scroll: function () {
            var e = this.options, t = e.state;
            if (e.behavior && this["scroll_" + e.behavior] !== i) return void this["scroll_" + e.behavior].call(this);
        ...
        switch (typeof i) {
            ...
            case"object":
                this.each(function () {
                    ...
                    o ? o.update(i) : (o = new e.infinitescroll(i, t, this), o.failed || e.data(this, "infinitescroll", o))
                })
        }
        return this
    };/*
