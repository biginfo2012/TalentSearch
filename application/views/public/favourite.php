                ...
                <ul class="wrap-group-list pl-0">
                    ...
                    <li>
                        ...
                        <div class="list-container">
                            ...
                            <div class="form-inline">
                                <div class="pull-right">
                                    <a class="btn btn-multi js-generate-group-public-access-url" data-group-id="1913"
                                    ...
                                    <a class="btn btn-multi js-generate-group-public-access-edit-url"
                                       data-group-id="1913" data-clipboard-target="generate_edit_url_5" rel="tooltip"
                                            ...
                                            <div class="wrap-influencer-detail columns">
                                                ...
                                                <div class="level networks" style="width: 240px;">
                                                    <ul class="level-item" style="width: 240px;">
                                                        <li>
                                                            <a href="https://www.instagram.com/cheeserland/" target="_blank"><span class="instagram"></span></a>
                                                        </li>
                                                        <li>
