		...
		<div class="row">
            ...
            <div class="col-md-6">
                <ul id="top_menu" class="nomargin">
                    ...
                    <li class="logouttop-usermenu__item logouttop-usermenu__item--contact"><a href="<?=base_url()?>">問い合わせ</a></li>
                    <li class="logouttop-usermenu__item logouttop-usermenu__item--favourite"><a href="<?=base_url()?>">お気に入りリスト</a></li>
                </ul>
            </div>
            <div class="col-md-3">
